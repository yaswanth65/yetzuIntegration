...
var getHydrationWarningType = function(message) {
    ...
    var normalizedMessage = message.startsWith('Warning: ') ? message : "Warning: " + message;
...
function getHydrationErrorStackInfo(error) {
    ...
    var _errorMessage_split1 = _sliced_to_array._(errorMessage.split("" + REACT_HYDRATION_ERROR_LINK), 2), message1 = _errorMessage_split1[0], maybeComponentStackDiff = _errorMessage_split1[1];
 ...
 */ function generateHydrationDiffReact18(message, firstContent, secondContent, lastArg) {
    ...
    for(var i = 0; i < components.length; i++){
        ...
        if (matchFirstContent || matchSecondContent) {
            ...
            diff += spaces1 + "<" + component + ">\n";
        }
    }
    if (hydrationWarningType === 'text') {
        var spaces2 = ' '.repeat(components.length * 2);
        diff += "+ " + spaces2 + '"' + firstContent + '"\n';
        diff += "- " + spaces2 + '"' + secondContent + '"\n';
    } else if (hydrationWarningType === 'text-in-tag') {
        var spaces3 = ' '.repeat(components.length * 2);
        diff += "> " + spaces3 + "<" + secondContent + ">\n";
        diff += ">   " + spaces3 + '"' + firstContent + '"\n';
    }
    return diff;
}
if ((typeof exports.default === 'function' || _type_of._(exports.default) === 'object' && exports.default !== null) && typeof exports.default.__esModule === 'undefined') {
...
function onUnhandledError(event) {
    var error = event == null ? void 0 : event.error;
    handleError(error);
