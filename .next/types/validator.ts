...
// Validate ../../src/app/(auth)/otp-verification/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/otp-verification">> = Specific
  const handler = {} as typeof import("../../src/app/(auth)/otp-verification/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../src/app/(site)/(legal)/code-of-conduct/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/code-of-conduct">> = Specific
  const handler = {} as typeof import("../../src/app/(site)/(legal)/code-of-conduct/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/(site)/(legal)/mentorhip-policy/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/mentorhip-policy">> = Specific
  const handler = {} as typeof import("../../src/app/(site)/(legal)/mentorhip-policy/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/(site)/(legal)/privacy-policy/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/privacy-policy">> = Specific
  const handler = {} as typeof import("../../src/app/(site)/(legal)/privacy-policy/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}

// Validate ../../src/app/(site)/(legal)/refund-policy/page.tsx
{
  type __IsExpected<Specific extends AppPageConfig<"/refund-policy">> = Specific
  const handler = {} as typeof import("../../src/app/(site)/(legal)/refund-policy/page.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
