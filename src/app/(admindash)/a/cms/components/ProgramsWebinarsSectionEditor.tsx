...
export function ProgramsWebinarsSectionEditor() {
  return (
    <div className="flex flex-col space-y-10 w-full animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      <section>
        ...
        <p className="text-sm text-slate-500 mb-4">Section uses shared ProgramsWebinarsSection component from components folder.</p>
      </section>
    </div>
  );
}
