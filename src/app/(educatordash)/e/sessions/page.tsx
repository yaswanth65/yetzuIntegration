        ...
        <div className="flex items-center bg-white border border-gray-200 rounded-xl p-1 inline-flex mb-2">
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
              activeView === 'Sessions List' ? 'bg-[#F2F5FF] text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-2 px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
              activeView === 'Calendar View' ? 'bg-[#F2F5FF] text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
