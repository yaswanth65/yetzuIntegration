    ...
    <>
      ...
      <section className="py-[80px] px-6 sm:px-[60px] md:px-[80px] lg:px-[108px] bg-[linear-gradient(180deg,#FFFFFF_0%,#E2E7FF_50.01%,#FFFFFF_100%)]">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="w-[1220px] flex flex-col gap-4">
            ...
            <div className="flex  gap-4">
              <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all w-[602px] h-[377px] flex flex-col justify-between p-6 relative">
                ...
                />
                <div className="absolute bottom-6 left-6 w-[333px]">
                  <h3 className="font-inter font-semibold text-[#252525] text-[22px] leading-[100%] tracking-[-0.06em]">
                    Assignment Submission &<br /> Reception
                  </h3>
                  <p className="font-sfpro font-normal text-[#252525] text-[14px] mt-3 leading-snug">
                    Students submit their assignments directly on Yetzu, initiating their academic task journey.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all w-[396px] h-[377px] flex flex-col justify-between p-6 relative">
                ...
                <div className="absolute bottom-6 left-6 w-[333px]">
                  ...
                  <p className="font-sfpro font-normal text-[#252525] text-[14px] mt-3 leading-snug">
                    Assignments undergo detailed review including proofreading, with students engaging mentors for clarifications and targeted guidance.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all w-[396px] h-[377px] flex flex-col justify-between p-6 relative">
                ...
                <div className="absolute bottom-6 left-6 w-[333px]">
                  ...
                  <p className="font-sfpro font-normal text-[#252525] text-[14px] mt-3 leading-snug">
                    Students track their assignment progress transparently, refining their work based on feedback until ready for submission.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition-all w-[602px] h-[377px] flex flex-col justify-between p-6 relative">
                ...
                <div className="absolute bottom-6 left-6 w-[333px]">
                  ...
                  <p className="font-sfpro font-normal text-[#252525] text-[14px] mt-3 leading-snug">
                    Upon final approval, students receive official recognition or certification from Yetzu, validating their academic achievement.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-[20px] shadow-lg overflow-hidden mb-[52px] flex flex-col md:flex-row justify-between p-[16px] md:p-[19px] gap-6 hover:shadow-xl transition-shadow">
            <div className="md:w-1/2 p-6 flex flex-col justify-between">
              <div>
                ...
                <p className="font-[SF Pro] font-normal text-[14px] leading-[150%] text-[#252525CC]">
